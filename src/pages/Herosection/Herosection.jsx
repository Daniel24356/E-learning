...
//                     <p className='rev-rate'>(Online Course)</p>
//                 </div>
//             </div>
...
//                 <h1>with Online Learning</h1>
//             </div>
//             <div className='discover-txt'>
//                 <p>Discover a world of knowledge and opportunities with our</p>
//                 <p>online education platform pursue a new career.</p>
//             </div>
...
//                      <p className='join-s'>Joint our online Class</p>
//                 </div>
//             </div>
//             </div>
