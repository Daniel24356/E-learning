...
import girlb from "../../assets/girl-button.png"
                ...
                <section className='study-sec'>
                    ...
                    <div>
                        <div className='gate-div'>
                            ...
                            <p>Gateway to Lifelong Learning</p>
                        </div>
                        <div className='studyhub'>
                            <h1>Know Studyhub Empowering</h1>
                            <h1>Learners Worldwide</h1>
                        </div>
                        <div className='passionate'>
                            <p>We are passionate about education and dedicated to providing high-</p>
                            <p>quality learning resources for learners of all backgrounds.</p>
                        </div>
                        <div className='learn-me'>
                            <div className='prof-box'>
                                <img src={purp1} alt="" />
                                <div>
                                    <p className='exp-txt'>Learn with Expert</p>
                                    <p className='pass-txt'>We are passionate education.</p>
                                </div>
                            </div>
                            <div className='prof-box'>
                                <img src={purp2} alt="" />
                        ...
                        <div className='cir-p'>
                            <div className='prof-cir'>
                                ...
                                <div className='ap-name'>
                                    <p className='exp-txt'>William James</p>
                                    <p className='pass-txt'>CEO, Studyhub Online Education</p>
                                </div>
                            </div>
